...
class DataQualityOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        dq_checks = [
            {'sql': "SELECT COUNT(*) FROM test_result WHERE test_id is null", 'expected_result':0},
            {'sql': "SELECT COUNT(*) FROM test_item WHERE id is null", 'expected_result':0},
            {'sql': "SELECT COUNT(*) FROM vehicle WHERE vehicle_id is null", 'expected_result':0},
            ]
